"""
Django settings for robot_monitoring project.
...
INSTALLED_APPS = [
    ...
    'dashboard',
    'fleet',
    'diagnostics',  # Добавьте эту строку
    'control',      # Добавьте эту строку
    'alerts',
    'reports',
    'settings',
    'monitoring',
...
ASGI_APPLICATION = 'robot_monitoring.asgi.application'
